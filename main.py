...
if __name__ == "__main__":
    ...
    # print(H_us_case.hr)
    # print(H_us_death.start_r)
    # print(H_us_death.end_r)
    # print(H_us_death.hr)

    print(H_china_case.start_r)
    print(H_china_case.end_r)
    print(H_china_case.hr)

    #show_plot(H_china_death, 'China Death', 'Date Index', 'Deaths')
    show_plot(H_china_case, 'China Case', 'Date Index', 'Cases')
